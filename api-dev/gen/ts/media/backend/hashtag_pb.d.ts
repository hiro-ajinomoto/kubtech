...
export class PublicListHashtagReq extends jspb.Message {
  ...
  setPagination(value?: base_base_pb.PaginationReq): PublicListHashtagReq;
  hasPagination(): boolean;
  clearPagination(): PublicListHashtagReq;

  getOrderByList(): Array<base_base_pb.OrderByItem>;
  setOrderByList(value: Array<base_base_pb.OrderByItem>): PublicListHashtagReq;
...
export class InternaUpsertHashtagsReq extends jspb.Message {
  getHashtagsList(): Array<string>;
  setHashtagsList(value: Array<string>): InternaUpsertHashtagsReq;
  clearHashtagsList(): InternaUpsertHashtagsReq;
  addHashtags(value: string, index?: number): InternaUpsertHashtagsReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): InternaUpsertHashtagsReq.AsObject;
  static toObject(includeInstance: boolean, msg: InternaUpsertHashtagsReq): InternaUpsertHashtagsReq.AsObject;
  static serializeBinaryToWriter(message: InternaUpsertHashtagsReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InternaUpsertHashtagsReq;
  static deserializeBinaryFromReader(message: InternaUpsertHashtagsReq, reader: jspb.BinaryReader): InternaUpsertHashtagsReq;
}

export namespace InternaUpsertHashtagsReq {
  export type AsObject = {
...
export class InternaUpsertHashtagsRes extends jspb.Message {
  getIdsList(): Array<string>;
  setIdsList(value: Array<string>): InternaUpsertHashtagsRes;
  clearIdsList(): InternaUpsertHashtagsRes;
  addIds(value: string, index?: number): InternaUpsertHashtagsRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): InternaUpsertHashtagsRes.AsObject;
  static toObject(includeInstance: boolean, msg: InternaUpsertHashtagsRes): InternaUpsertHashtagsRes.AsObject;
  static serializeBinaryToWriter(message: InternaUpsertHashtagsRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InternaUpsertHashtagsRes;
  static deserializeBinaryFromReader(message: InternaUpsertHashtagsRes, reader: jspb.BinaryReader): InternaUpsertHashtagsRes;
}

export namespace InternaUpsertHashtagsRes {
  export type AsObject = {
    idsList: Array<string>,
  }
}
...
export class InternalListHashtagByIdsRes extends jspb.Message {
  getItemsList(): Array<HashtagInfo>;
  setItemsList(value: Array<HashtagInfo>): InternalListHashtagByIdsRes;
  clearItemsList(): InternalListHashtagByIdsRes;
  addItems(value?: HashtagInfo, index?: number): HashtagInfo;
...
export namespace InternalListHashtagByIdsRes {
  export type AsObject = {
    itemsList: Array<HashtagInfo.AsObject>,
  }
}
...
export class PublicListHashtagRes extends jspb.Message {
  ...
  setPagination(value?: base_base_pb.PaginationRes): PublicListHashtagRes;
  hasPagination(): boolean;
