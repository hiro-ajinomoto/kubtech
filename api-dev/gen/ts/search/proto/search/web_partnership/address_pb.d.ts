...
import * as proto_search_web_partnership_base_pb from '../../../proto/search/web_partnership/base_pb';
...
export class SearchAddressReq extends jspb.Message {
  getPagination(): proto_search_web_partnership_base_pb.PaginationReq | undefined;
  setPagination(value?: proto_search_web_partnership_base_pb.PaginationReq): SearchAddressReq;
...
export namespace SearchAddressReq {
  export type AsObject = {
    pagination?: proto_search_web_partnership_base_pb.PaginationReq.AsObject,
    address: string,
  }
}
...
export class SearchByPostcodeReq extends jspb.Message {
  getPagination(): proto_search_web_partnership_base_pb.PaginationReq | undefined;
  setPagination(value?: proto_search_web_partnership_base_pb.PaginationReq): SearchByPostcodeReq;
  hasPagination(): boolean;
...
export class SearchAddressRes extends jspb.Message {
  getPagination(): proto_search_web_partnership_base_pb.PaginationRes | undefined;
  setPagination(value?: proto_search_web_partnership_base_pb.PaginationRes): SearchAddressRes;
  hasPagination(): boolean;
...
export namespace SearchAddressRes {
  export type AsObject = {
    pagination?: proto_search_web_partnership_base_pb.PaginationRes.AsObject,
