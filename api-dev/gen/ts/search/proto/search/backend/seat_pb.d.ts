...
export class InternalCheckModifyPriceBlockReq extends jspb.Message {
  getSeatPriceBlockId(): string;
  setSeatPriceBlockId(value: string): InternalCheckModifyPriceBlockReq;

  getGeneralSeatMapId(): string;
  setGeneralSeatMapId(value: string): InternalCheckModifyPriceBlockReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): InternalCheckModifyPriceBlockReq.AsObject;
  static toObject(includeInstance: boolean, msg: InternalCheckModifyPriceBlockReq): InternalCheckModifyPriceBlockReq.AsObject;
  static serializeBinaryToWriter(message: InternalCheckModifyPriceBlockReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InternalCheckModifyPriceBlockReq;
  static deserializeBinaryFromReader(message: InternalCheckModifyPriceBlockReq, reader: jspb.BinaryReader): InternalCheckModifyPriceBlockReq;
}

export namespace InternalCheckModifyPriceBlockReq {
  export type AsObject = {
    seatPriceBlockId: string,
    generalSeatMapId: string,
  }
...
export class InternalCheckModifyPriceBlockRes extends jspb.Message {
  getIsAble(): boolean;
  setIsAble(value: boolean): InternalCheckModifyPriceBlockRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): InternalCheckModifyPriceBlockRes.AsObject;
  static toObject(includeInstance: boolean, msg: InternalCheckModifyPriceBlockRes): InternalCheckModifyPriceBlockRes.AsObject;
  static serializeBinaryToWriter(message: InternalCheckModifyPriceBlockRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InternalCheckModifyPriceBlockRes;
  static deserializeBinaryFromReader(message: InternalCheckModifyPriceBlockRes, reader: jspb.BinaryReader): InternalCheckModifyPriceBlockRes;
}

export namespace InternalCheckModifyPriceBlockRes {
  export type AsObject = {
    isAble: boolean,
  }
}
