...
export class UserInfo extends jspb.Message {
  ...
  getIsOwner(): proto_partnership_web_partnership_base_pb.Boolean;
  setIsOwner(value: proto_partnership_web_partnership_base_pb.Boolean): UserInfo;
...
export namespace UserInfo {
  export type AsObject = {
    ...
    isOwner: proto_partnership_web_partnership_base_pb.Boolean,
    phoneCode: string,
    phoneNumber: string,
  }
}

export class UserBasicInfo extends jspb.Message {
  getId(): string;
  setId(value: string): UserBasicInfo;

  getEmail(): string;
  setEmail(value: string): UserBasicInfo;

  getName(): string;
  setName(value: string): UserBasicInfo;

  getProfilePicture(): string;
  setProfilePicture(value: string): UserBasicInfo;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UserBasicInfo.AsObject;
  static toObject(includeInstance: boolean, msg: UserBasicInfo): UserBasicInfo.AsObject;
  static serializeBinaryToWriter(message: UserBasicInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UserBasicInfo;
  static deserializeBinaryFromReader(message: UserBasicInfo, reader: jspb.BinaryReader): UserBasicInfo;
}
...
export class CreateUserReq extends jspb.Message {
  ...
  getName(): string;
  setName(value: string): CreateUserReq;

  getProfilePicture(): string;
  setProfilePicture(value: string): CreateUserReq;

  getDescription(): string;
  setDescription(value: string): CreateUserReq;

  getPartnershipId(): string;
  setPartnershipId(value: string): CreateUserReq;

  getPhoneCode(): string;
  setPhoneCode(value: string): CreateUserReq;

  getPhoneNumber(): string;
  setPhoneNumber(value: string): CreateUserReq;
...
export class GetBasicUsersReq extends jspb.Message {
  getIdsList(): Array<string>;
  setIdsList(value: Array<string>): GetBasicUsersReq;
  clearIdsList(): GetBasicUsersReq;
  addIds(value: string, index?: number): GetBasicUsersReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetBasicUsersReq.AsObject;
  static toObject(includeInstance: boolean, msg: GetBasicUsersReq): GetBasicUsersReq.AsObject;
  static serializeBinaryToWriter(message: GetBasicUsersReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetBasicUsersReq;
  static deserializeBinaryFromReader(message: GetBasicUsersReq, reader: jspb.BinaryReader): GetBasicUsersReq;
}

export namespace GetBasicUsersReq {
  export type AsObject = {
...
export class UpdateUserReq extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): UpdateUserReq;

  getName(): string;
  setName(value: string): UpdateUserReq;

  getProfilePicture(): string;
  setProfilePicture(value: string): UpdateUserReq;

  getDescription(): string;
  setDescription(value: string): UpdateUserReq;
...
export class DeleteUserReq extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): DeleteUserReq;
...
export class DisableUserReq extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): DisableUserReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): DisableUserReq.AsObject;
  static toObject(includeInstance: boolean, msg: DisableUserReq): DisableUserReq.AsObject;
  static serializeBinaryToWriter(message: DisableUserReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): DisableUserReq;
  static deserializeBinaryFromReader(message: DisableUserReq, reader: jspb.BinaryReader): DisableUserReq;
}

export namespace DisableUserReq {
  export type AsObject = {
    userId: string,
  }
}
...
export class GetBasicUsersRes extends jspb.Message {
  getItemsList(): Array<UserBasicInfo>;
  setItemsList(value: Array<UserBasicInfo>): GetBasicUsersRes;
  clearItemsList(): GetBasicUsersRes;
  addItems(value?: UserBasicInfo, index?: number): UserBasicInfo;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetBasicUsersRes.AsObject;
  static toObject(includeInstance: boolean, msg: GetBasicUsersRes): GetBasicUsersRes.AsObject;
  static serializeBinaryToWriter(message: GetBasicUsersRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetBasicUsersRes;
  static deserializeBinaryFromReader(message: GetBasicUsersRes, reader: jspb.BinaryReader): GetBasicUsersRes;
}

export namespace GetBasicUsersRes {
  export type AsObject = {
    itemsList: Array<UserBasicInfo.AsObject>,
  }
}
...
export class CreateUserRes extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): CreateUserRes;
