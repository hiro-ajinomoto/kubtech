...
export class UpdatePartnershipReq extends jspb.Message {
  getId(): string;
  setId(value: string): UpdatePartnershipReq;

  getCodeName(): string;
  setCodeName(value: string): UpdatePartnershipReq;

  getFullName(): string;
  setFullName(value: string): UpdatePartnershipReq;

  getColor(): string;
  setColor(value: string): UpdatePartnershipReq;

  getSlogan(): string;
  setSlogan(value: string): UpdatePartnershipReq;

  getLogo(): string;
  setLogo(value: string): UpdatePartnershipReq;

  getDefaultCurrency(): string;
  setDefaultCurrency(value: string): UpdatePartnershipReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): UpdatePartnershipReq.AsObject;
  static toObject(includeInstance: boolean, msg: UpdatePartnershipReq): UpdatePartnershipReq.AsObject;
  static serializeBinaryToWriter(message: UpdatePartnershipReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): UpdatePartnershipReq;
  static deserializeBinaryFromReader(message: UpdatePartnershipReq, reader: jspb.BinaryReader): UpdatePartnershipReq;
}

export namespace UpdatePartnershipReq {
  export type AsObject = {
    id: string,
    codeName: string,
    fullName: string,
...
export class PublicGetPartnershipByCodeRes extends jspb.Message {
  ...
  getDefaultCurrency(): string;
  setDefaultCurrency(value: string): PublicGetPartnershipByCodeRes;
