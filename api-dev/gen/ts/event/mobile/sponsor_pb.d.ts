...
export class SponsorBasicInfo extends jspb.Message {
  ...
  setContactUrlsList(value: Array<event_mobile_base_pb.Url>): SponsorBasicInfo;
...
export class SponsorInfo extends jspb.Message {
  ...
  getContactUrlsList(): Array<event_mobile_base_pb.Url>;
  setContactUrlsList(value: Array<event_mobile_base_pb.Url>): SponsorInfo;
...
export class GetSponsorDetailRes extends jspb.Message {
  ...
  getContactUrlsList(): Array<event_mobile_base_pb.Url>;
  setContactUrlsList(value: Array<event_mobile_base_pb.Url>): GetSponsorDetailRes;
