...
export class OrderInfo extends jspb.Message {
  ...
  getOrderProductType(): OrderProductType;
  setOrderProductType(value: OrderProductType): OrderInfo;

  getOrderEventId(): string;
  setOrderEventId(value: string): OrderInfo;

  getIsCheckIn(): boolean;
  setIsCheckIn(value: boolean): OrderInfo;
...
export class ProductEventInfo extends jspb.Message {
  ...
  getStartTime(): number;
  setStartTime(value: number): ProductEventInfo;

  getEndTime(): number;
  setEndTime(value: number): ProductEventInfo;

  getCheckinStartTime(): number;
  setCheckinStartTime(value: number): ProductEventInfo;

  getCheckinEndTime(): number;
  setCheckinEndTime(value: number): ProductEventInfo;

  getTimezone(): string;
  setTimezone(value: string): ProductEventInfo;

  getSeatInfo(): SeatInfo | undefined;
  setSeatInfo(value?: SeatInfo): ProductEventInfo;
  hasSeatInfo(): boolean;
  clearSeatInfo(): ProductEventInfo;
...
export class OrderProductInfo extends jspb.Message {
  ...
  setUnlimited(value: boolean): OrderProductInfo;
  ...
  getEventInfo(): ProductEventInfo | undefined;
  setEventInfo(value?: ProductEventInfo): OrderProductInfo;
  hasEventInfo(): boolean;
  clearEventInfo(): OrderProductInfo;
...
export namespace OrderProductInfo {
  export type AsObject = {
    ...
    country: string,
    language: string,
    eventInfo?: ProductEventInfo.AsObject,
  }
}
...
export class GetMyOrderHistoryReq extends jspb.Message {
  ...
  setPagination(value?: base_base_pb.PaginationReq): GetMyOrderHistoryReq;
...
export class GetMyOrderTicketsReq extends jspb.Message {
  getStatus(): OrderStatus;
  setStatus(value: OrderStatus): GetMyOrderTicketsReq;

  getPagination(): base_base_pb.PaginationReq | undefined;
  setPagination(value?: base_base_pb.PaginationReq): GetMyOrderTicketsReq;
  hasPagination(): boolean;
  clearPagination(): GetMyOrderTicketsReq;

  getSearchEvent(): string;
  setSearchEvent(value: string): GetMyOrderTicketsReq;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetMyOrderTicketsReq.AsObject;
  static toObject(includeInstance: boolean, msg: GetMyOrderTicketsReq): GetMyOrderTicketsReq.AsObject;
  static serializeBinaryToWriter(message: GetMyOrderTicketsReq, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetMyOrderTicketsReq;
  static deserializeBinaryFromReader(message: GetMyOrderTicketsReq, reader: jspb.BinaryReader): GetMyOrderTicketsReq;
}

export namespace GetMyOrderTicketsReq {
  export type AsObject = {
    status: OrderStatus,
    pagination?: base_base_pb.PaginationReq.AsObject,
    searchEvent: string,
...
export class GetMyOrderHistoryRes extends jspb.Message {
  getListList(): Array<OrderInfo>;
  setListList(value: Array<OrderInfo>): GetMyOrderHistoryRes;
  clearListList(): GetMyOrderHistoryRes;
  addList(value?: OrderInfo, index?: number): OrderInfo;

  getPagination(): base_base_pb.PaginationRes | undefined;
  setPagination(value?: base_base_pb.PaginationRes): GetMyOrderHistoryRes;
  hasPagination(): boolean;
...
export namespace GetMyOrderHistoryRes {
  export type AsObject = {
    listList: Array<OrderInfo.AsObject>,
    pagination?: base_base_pb.PaginationRes.AsObject,
  }
}

export class GetMyOrderTicketsRes extends jspb.Message {
  getListList(): Array<OrderInfo>;
  setListList(value: Array<OrderInfo>): GetMyOrderTicketsRes;
  clearListList(): GetMyOrderTicketsRes;
  addList(value?: OrderInfo, index?: number): OrderInfo;

  getPagination(): base_base_pb.PaginationRes | undefined;
  setPagination(value?: base_base_pb.PaginationRes): GetMyOrderTicketsRes;
  hasPagination(): boolean;
  clearPagination(): GetMyOrderTicketsRes;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): GetMyOrderTicketsRes.AsObject;
  static toObject(includeInstance: boolean, msg: GetMyOrderTicketsRes): GetMyOrderTicketsRes.AsObject;
  static serializeBinaryToWriter(message: GetMyOrderTicketsRes, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): GetMyOrderTicketsRes;
  static deserializeBinaryFromReader(message: GetMyOrderTicketsRes, reader: jspb.BinaryReader): GetMyOrderTicketsRes;
}

export namespace GetMyOrderTicketsRes {
  export type AsObject = {
    listList: Array<OrderInfo.AsObject>,
    pagination?: base_base_pb.PaginationRes.AsObject,
  }
