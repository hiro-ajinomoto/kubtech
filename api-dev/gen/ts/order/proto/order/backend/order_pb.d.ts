...
import * as proto_order_backend_base_pb from '../../../proto/order/backend/base_pb';
...
export class OrderProductInfo extends jspb.Message {
  ...
  getUnlimited(): proto_order_backend_base_pb.Boolean;
  setUnlimited(value: proto_order_backend_base_pb.Boolean): OrderProductInfo;
...
export namespace OrderProductInfo {
  export type AsObject = {
    ...
    brand: string,
    unlimited: proto_order_backend_base_pb.Boolean,
    partnershipId: string,
    country: string,
    language: string,
  }
