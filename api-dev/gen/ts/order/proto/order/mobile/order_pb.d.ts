...
import * as proto_order_mobile_base_pb from '../../../proto/order/mobile/base_pb';
...
export class OrderProductInfo extends jspb.Message {
  ...
  getStatus(): proto_order_mobile_base_pb.ProductStatus;
  setStatus(value: proto_order_mobile_base_pb.ProductStatus): OrderProductInfo;
  ...
  getUnlimited(): proto_order_mobile_base_pb.CustomBoolean;
  setUnlimited(value: proto_order_mobile_base_pb.CustomBoolean): OrderProductInfo;
...
export namespace OrderProductInfo {
  export type AsObject = {
    id: string,
    status: proto_order_mobile_base_pb.ProductStatus,
    name: string,
    ...
    brand: string,
    unlimited: proto_order_mobile_base_pb.CustomBoolean,
    partnershipId: string,
    country: string,
    language: string,
  }
...
export class GetMyOrderHistoryReq extends jspb.Message {
  ...
  getPagination(): proto_order_mobile_base_pb.PaginationReq | undefined;
  setPagination(value?: proto_order_mobile_base_pb.PaginationReq): GetMyOrderHistoryReq;
...
export namespace GetMyOrderHistoryReq {
  export type AsObject = {
    status: OrderStatus,
    pagination?: proto_order_mobile_base_pb.PaginationReq.AsObject,
  }
}
...
export class GetMyOrderHistoryRes extends jspb.Message {
  ...
  getPagination(): proto_order_mobile_base_pb.PaginationRes | undefined;
  setPagination(value?: proto_order_mobile_base_pb.PaginationRes): GetMyOrderHistoryRes;
  hasPagination(): boolean;
...
export namespace GetMyOrderHistoryRes {
  export type AsObject = {
    ...
    pagination?: proto_order_mobile_base_pb.PaginationRes.AsObject,
  }
}
