...
export class CartProductInfo extends jspb.Message {
  ...
  setStatus(value: proto_order_mobile_base_pb.ProductStatus): CartProductInfo;
  ...
  setUnlimited(value: proto_order_mobile_base_pb.CustomBoolean): CartProductInfo;
  ...
  setSeatInfo(value?: SeatInfo): CartProductInfo;
  hasSeatInfo(): boolean;
  clearSeatInfo(): CartProductInfo;
