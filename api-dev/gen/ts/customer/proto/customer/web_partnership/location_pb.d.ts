...
export class CustomerLocationBasicInfo extends jspb.Message {
  ...
  getCoordinates(): proto_customer_web_partnership_base_pb.Coordinates | undefined;
  setCoordinates(value?: proto_customer_web_partnership_base_pb.Coordinates): CustomerLocationBasicInfo;
...
export namespace CustomerLocationBasicInfo {
  export type AsObject = {
    name: string,
    description: string,
    coordinates?: proto_customer_web_partnership_base_pb.Coordinates.AsObject,
    unit: string,
    number: string,
    street: string,
    ward: string,
...
export class ListMyLocationReq extends jspb.Message {
  ...
  getPagination(): proto_customer_web_partnership_base_pb.PaginationReq | undefined;
  setPagination(value?: proto_customer_web_partnership_base_pb.PaginationReq): ListMyLocationReq;
  hasPagination(): boolean;
  clearPagination(): ListMyLocationReq;

  getOrderByList(): Array<proto_customer_web_partnership_base_pb.OrderByItem>;
  setOrderByList(value: Array<proto_customer_web_partnership_base_pb.OrderByItem>): ListMyLocationReq;
  clearOrderByList(): ListMyLocationReq;
  addOrderBy(value?: proto_customer_web_partnership_base_pb.OrderByItem, index?: number): proto_customer_web_partnership_base_pb.OrderByItem;
...
export namespace ListMyLocationReq {
  export type AsObject = {
    searchText: string,
    pagination?: proto_customer_web_partnership_base_pb.PaginationReq.AsObject,
    orderByList: Array<proto_customer_web_partnership_base_pb.OrderByItem.AsObject>,
  }
}
...
export class ListMyLocationRes extends jspb.Message {
  ...
  getPagination(): proto_customer_web_partnership_base_pb.PaginationRes | undefined;
  setPagination(value?: proto_customer_web_partnership_base_pb.PaginationRes): ListMyLocationRes;
  hasPagination(): boolean;
...
export namespace ListMyLocationRes {
  export type AsObject = {
    ...
    pagination?: proto_customer_web_partnership_base_pb.PaginationRes.AsObject,
  }
}
