...
export class InspectorTicketCheckinEventInfo extends jspb.Message {
  ...
  getMediasList(): Array<ticket_mobile_inspector_base_pb.Media>;
  setMediasList(value: Array<ticket_mobile_inspector_base_pb.Media>): InspectorTicketCheckinEventInfo;
  clearMediasList(): InspectorTicketCheckinEventInfo;
  addMedias(value?: ticket_mobile_inspector_base_pb.Media, index?: number): ticket_mobile_inspector_base_pb.Media;
...
export namespace InspectorTicketCheckinEventInfo {
  export type AsObject = {
    ...
    mediasList: Array<ticket_mobile_inspector_base_pb.Media.AsObject>,
    seatMapUrl: string,
...
export class InspectorTicketCheckinEventAssignInfo extends jspb.Message {
  getEventId(): string;
  setEventId(value: string): InspectorTicketCheckinEventAssignInfo;

  getName(): string;
  setName(value: string): InspectorTicketCheckinEventAssignInfo;

  getStartTime(): number;
  setStartTime(value: number): InspectorTicketCheckinEventAssignInfo;

  getEndTime(): number;
  setEndTime(value: number): InspectorTicketCheckinEventAssignInfo;

  getCheckinStartTime(): number;
  setCheckinStartTime(value: number): InspectorTicketCheckinEventAssignInfo;

  getCheckinEndTime(): number;
  setCheckinEndTime(value: number): InspectorTicketCheckinEventAssignInfo;

  getLocation(): InspectorTicketEventLocation | undefined;
  setLocation(value?: InspectorTicketEventLocation): InspectorTicketCheckinEventAssignInfo;
  hasLocation(): boolean;
  clearLocation(): InspectorTicketCheckinEventAssignInfo;

  getTimezone(): string;
  setTimezone(value: string): InspectorTicketCheckinEventAssignInfo;

  getPartnershipId(): string;
  setPartnershipId(value: string): InspectorTicketCheckinEventAssignInfo;

  getGeneralSeatMapId(): string;
  setGeneralSeatMapId(value: string): InspectorTicketCheckinEventAssignInfo;

  getMediasList(): Array<ticket_mobile_inspector_base_pb.Media>;
  setMediasList(value: Array<ticket_mobile_inspector_base_pb.Media>): InspectorTicketCheckinEventAssignInfo;
  clearMediasList(): InspectorTicketCheckinEventAssignInfo;
  addMedias(value?: ticket_mobile_inspector_base_pb.Media, index?: number): ticket_mobile_inspector_base_pb.Media;

  getGeneralSeatMapName(): string;
  setGeneralSeatMapName(value: string): InspectorTicketCheckinEventAssignInfo;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): InspectorTicketCheckinEventAssignInfo.AsObject;
  static toObject(includeInstance: boolean, msg: InspectorTicketCheckinEventAssignInfo): InspectorTicketCheckinEventAssignInfo.AsObject;
  static serializeBinaryToWriter(message: InspectorTicketCheckinEventAssignInfo, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): InspectorTicketCheckinEventAssignInfo;
  static deserializeBinaryFromReader(message: InspectorTicketCheckinEventAssignInfo, reader: jspb.BinaryReader): InspectorTicketCheckinEventAssignInfo;
}

export namespace InspectorTicketCheckinEventAssignInfo {
  export type AsObject = {
    eventId: string,
    name: string,
    startTime: number,
...
export class InspectorTicketUserInfo extends jspb.Message {
  getUserId(): string;
  setUserId(value: string): InspectorTicketUserInfo;
...
export class AssignCheckinEventReq extends jspb.Message {
  ...
  getEventInfo(): InspectorTicketCheckinEventAssignInfo | undefined;
  setEventInfo(value?: InspectorTicketCheckinEventAssignInfo): AssignCheckinEventReq;
  hasEventInfo(): boolean;
  clearEventInfo(): AssignCheckinEventReq;
...
export namespace AssignCheckinEventReq {
  export type AsObject = {
    inspectorId: string,
    eventInfo?: InspectorTicketCheckinEventAssignInfo.AsObject,
  }
}
