...
export class ProductInfo extends jspb.Message {
  ...
  setMediasList(value: Array<product_base_pb.Media>): ProductInfo;
...
export class CreateProductReq extends jspb.Message {
  ...
  getMediasList(): Array<product_base_pb.Media>;
  setMediasList(value: Array<product_base_pb.Media>): CreateProductReq;
...
export class UpdateProductReq extends jspb.Message {
  ...
  getMediasList(): Array<product_base_pb.Media>;
  setMediasList(value: Array<product_base_pb.Media>): UpdateProductReq;
...
export class PublicListProductReq extends jspb.Message {
  ...
  setPagination(value?: product_base_pb.PaginationReq): PublicListProductReq;
  hasPagination(): boolean;
  clearPagination(): PublicListProductReq;

  getOrderByList(): Array<product_base_pb.OrderByItem>;
  setOrderByList(value: Array<product_base_pb.OrderByItem>): PublicListProductReq;
  clearOrderByList(): PublicListProductReq;
  addOrderBy(value?: product_base_pb.OrderByItem, index?: number): product_base_pb.OrderByItem;
...
export namespace PublicListProductReq {
  export type AsObject = {
    ...
    orderByList: Array<product_base_pb.OrderByItem.AsObject>,
    partnershipId: string,
  }
}
...
export class PublicListProductRes extends jspb.Message {
  ...
  setPagination(value?: product_base_pb.PaginationRes): PublicListProductRes;
  hasPagination(): boolean;
