...
export class PartnerLocationBasicInfo extends jspb.Message {
  ...
  getCoordinates(): proto_partner_web_partnership_base_pb.Coordinates | undefined;
  setCoordinates(value?: proto_partner_web_partnership_base_pb.Coordinates): PartnerLocationBasicInfo;
...
export namespace PartnerLocationBasicInfo {
  export type AsObject = {
    name: string,
    description: string,
    coordinates?: proto_partner_web_partnership_base_pb.Coordinates.AsObject,
    unit: string,
    number: string,
    street: string,
    ward: string,
...
export class ListPartnerLocationReq extends jspb.Message {
  ...
  setPagination(value?: proto_partner_web_partnership_base_pb.PaginationReq): ListPartnerLocationReq;
  hasPagination(): boolean;
  clearPagination(): ListPartnerLocationReq;

  getOrderByList(): Array<proto_partner_web_partnership_base_pb.OrderByItem>;
  setOrderByList(value: Array<proto_partner_web_partnership_base_pb.OrderByItem>): ListPartnerLocationReq;
...
export class ListPartnerLocationRes extends jspb.Message {
  ...
  setPagination(value?: proto_partner_web_partnership_base_pb.PaginationRes): ListPartnerLocationRes;
  hasPagination(): boolean;
