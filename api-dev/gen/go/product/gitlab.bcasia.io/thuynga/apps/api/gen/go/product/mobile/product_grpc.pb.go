...
func (c *productServiceClient) RetrieveProduct(ctx context.Context, in *RetrieveProductReq, opts ...grpc.CallOption) (*RetrieveProductRes, error) {
	...
	err := c.cc.Invoke(ctx, "/product.mobile.ProductService/RetrieveProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) ListProduct(ctx context.Context, in *ListProductReq, opts ...grpc.CallOption) (*ListProductRes, error) {
	...
	err := c.cc.Invoke(ctx, "/product.mobile.ProductService/ListProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) ListProductBySeats(ctx context.Context, in *ListProductBySeatsReq, opts ...grpc.CallOption) (*ListProductRes, error) {
	out := new(ListProductRes)
	err := c.cc.Invoke(ctx, "/product.mobile.ProductService/ListProductBySeats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) PublicRetrieveProduct(ctx context.Context, in *PublicRetrieveProductReq, opts ...grpc.CallOption) (*PublicRetrieveProductRes, error) {
	...
	err := c.cc.Invoke(ctx, "/product.mobile.ProductService/PublicRetrieveProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productServiceClient) PublicListProduct(ctx context.Context, in *PublicListProductReq, opts ...grpc.CallOption) (*PublicListProductRes, error) {
	...
	err := c.cc.Invoke(ctx, "/product.mobile.ProductService/PublicListProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_RetrieveProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.mobile.ProductService/RetrieveProduct",
	}
...
func _ProductService_ListProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.mobile.ProductService/ListProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_ListProductBySeats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.mobile.ProductService/ListProductBySeats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_PublicRetrieveProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.mobile.ProductService/PublicRetrieveProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductService_PublicListProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/product.mobile.ProductService/PublicListProduct",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "product.mobile.ProductService",
	...
	Metadata: "proto/product/mobile/product.proto",
}
