...
type SeatServiceClient interface {
	...
	DeleteSeats(ctx context.Context, in *DeleteSeatsReq, opts ...grpc.CallOption) (*base.Empty, error)
...
func (c *seatServiceClient) DeleteSeats(ctx context.Context, in *DeleteSeatsReq, opts ...grpc.CallOption) (*base.Empty, error) {
	out := new(base.Empty)
...
type SeatServiceServer interface {
	...
	DeleteSeats(context.Context, *DeleteSeatsReq) (*base.Empty, error)
...
func (UnimplementedSeatServiceServer) DeleteSeats(context.Context, *DeleteSeatsReq) (*base.Empty, error) {
...
var SeatService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "product/web_partnership/seat.proto",
}
